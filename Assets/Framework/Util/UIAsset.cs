...
namespace LowoUN.Module.UI {
	...
	public sealed class UIAsset : MonoBehaviour {
		...
		void Awake () {
			...
			uiRootTypDict = new Dictionary<Enum_UIAsset, Transform> () { { Enum_UIAsset.General, root_General }, { Enum_UIAsset.General2, root_General2 }, { Enum_UIAsset.GeneralTop, root_GeneralTop }, { Enum_UIAsset.CheckDlg, root_CheckDlg }, { Enum_UIAsset.Reward, root_Reward }, { Enum_UIAsset.Test, root_Test }, { Enum_UIAsset.Notify, root_Notify },
			};
